...
var warnIfValueOutOfBounds = function warnIfValueOutOfBounds(value, min, max) {
  ...
  var _iterator = (0,C_Users_msiss_Documents_ionicprojet_Saraliw2_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelper_js__WEBPACK_IMPORTED_MODULE_1__["default"])(valueArray),
      _step;
...
var getDaysOfMonth = function getDaysOfMonth(month, year, firstDayOfWeek) {
  ...
  for (var _i = 0; _i <= offset; _i++) {
    days = [{
      day: null,
      dayOfWeek: null
    }].concat((0,C_Users_msiss_Documents_ionicprojet_Saraliw2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(days));
  }
...
var getAllMonthsInRange = function getAllMonthsInRange(currentParts, maxParts) {
  ...
  return [currentParts].concat((0,C_Users_msiss_Documents_ionicprojet_Saraliw2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(getAllMonthsInRange(getNextMonth(currentParts), maxParts)));
};
/**
...
var getCombinedDateColumnData = function getCombinedDateColumnData(locale, todayParts, minParts, maxParts, dayValues, monthValues) {
  ...
  months.forEach(function (monthObject) {
    ...
    parts = [].concat((0,C_Users_msiss_Documents_ionicprojet_Saraliw2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(parts), dateParts);
    items = [].concat((0,C_Users_msiss_Documents_ionicprojet_Saraliw2_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(items), dateColumnItems);
  });
  return {
    parts: parts,
    items: items
